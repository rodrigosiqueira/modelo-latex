...
% metadados do PDF
\title{Uma visão sobre a próxima geração de abstrações de processos em sistemas operacionais}
...
\input{chapters/cap-fundamentacao-teorica}
\par

\input{chapters/cap-trabalhos-analisados}
\par

\input{chapters/cap-validacoes}
\par

\input{chapters/cap-estudo-de-caso}
\par

\input{chapters/cap-analise-sobre-abstracoes-de-processos}
\par
