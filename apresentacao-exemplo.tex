...
\begin{frame}{Uma Breve Jornada Sobre os Processos}
  \begin{figure}[!h]
    ...
    \caption*{Única thread e multi-thread. Note o isolamento da pilha e dos registrador (PC)}
...
\begin{frame}{Gerenciamento da Memória Relacionada aos Processos}
  \begin{itemize}
    ...
    \item Endereço Lógico
    \item Espaço de Endereçamento Virtual (VAS) e Lógico
  \end{itemize}
\end{frame}
...
\begin{frame}{O Modelo de Paginação}
  \begin{figure}[!h]
    \centering
    \includegraphics[width=0.7\textwidth]{paginacao} 
