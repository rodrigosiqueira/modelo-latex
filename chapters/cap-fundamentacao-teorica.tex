...
% TODO: Avisar que vamos dar um panorama e aprofundar os conceitos para esse
% trabalho. Falar também que boa parte dos conceitos são baseados no livro X,y
...
pelos montadores \citep{gdb}. O \textbf{segmento de Mapeamento de Memória}
...
% TODO: Talvez essas seções fiquem melhor mais para frente e se forem
% mais gerais
...
% TODO: Claramente você explicou um modelo antigo. Tu deve deixar isso claro
%aqui no fim ou logo no começo. Lembrar que o objetivo é só apresentar os
%conceitos
