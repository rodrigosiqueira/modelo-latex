...
Outros dois importantes aspectos da arquitetura do Apache são o \textbf{Content
...
O Nginx sugere uma abordagem nova para os problemas referentes ao servidor web,
...
O SSL e outros possuem um mecanismo chamado de \boldAndIndex{handshake} que
...
O GC é uma aplicação que executa com a JVM e demais a própria aplicação, por
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=\textwidth]{gc_algoritmo.png}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.8\textwidth]{gc_memory.png}
