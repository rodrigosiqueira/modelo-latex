...
\textit{microbenchmarks} o que podem evidenciar um resultado desejado e não
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=.50\textwidth]{request_a_page.png}
...
um mecanismo chamado de \boldAndIndex{keep-alive} que fornece uma conexão
