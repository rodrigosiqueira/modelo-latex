\imgchapter[right,width=8cm,bleed=19pt,shift=37pt]{chapter_3_title}{Trabalhos Analisados}
...
Wedge permite que o programador crie um número arbitrário de
...
Resumidamente, o \emph{Resource Container} é um projeto na qual podemos
