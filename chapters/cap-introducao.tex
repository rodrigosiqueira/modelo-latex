...
% Microbenchmark: Trata-se de uma medição da menor únidade possível feita do espaço de usuário  ...  É uma maneira de identificar tarefas da aplicação e medir o desempenho delas
