\chapter{Estudo de Caso} \label{cap:estudo-de-caso}
...
\begin{itemize} \item \textbf{StartServers}: Este parâmetro espera um inteiro
...
\begin{table} \centering \begin{tabular}{|c|c|c|c|} \hline \textit{Parameter} &
...
\begin{figure}[!h] \centering \includegraphics[width=\textwidth]{mvas_httpd}
...
\lstinputlisting[ language=C, caption={Alteração no Apache Server},
label={lst:http_core} ]{code/http_core.c}
...
\begin{figure}[!h] \centering
\includegraphics[width=.90\textwidth]{static_file} \caption{Arquivos estáticos:
